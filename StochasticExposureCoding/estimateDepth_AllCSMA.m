function [d_hat, M_ON] = estimateDepth_AllCSMA(d, c, p, N, M, A, e_s, e_a, e_i, f_mod, T, frac)
...
binarySeq = binornd(1, p, N+1, M);                  % N by M matrix: 1st row for primary camera, N rows for the interfering cameras
